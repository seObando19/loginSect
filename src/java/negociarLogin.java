...
public class negociarLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet negociarLogin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet negociarLogin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //Despachador de respuesta->que valida la autenticacion
        ...
        //Despachador de respuesta (enrutar la respuesta)
